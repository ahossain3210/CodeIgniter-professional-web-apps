    ...
    <div class="blog">
        <div class="row">
            ...
            <div class="col-sm-9 view_course">
                <h3><i class="fa fa-eye" aria-hidden="true"></i> View Our Courses</h3>
            </div>
            <div class="col-md-9 course_wrap">
                
                <?php
                foreach ($all_publish_course as $v_course) {
                    ?>
                    <div class="col-xs-12 col-sm-12 course_info_wrap">
                        <div class="col-md-9 course_title">
                        ...
                        <div class="col-md-3 course_title_2" style="text-align: center;">
