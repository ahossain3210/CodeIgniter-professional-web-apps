                        ...
                        <ul class="nav pull-right">
                            ...
                            <li class="dropdown hidden-phone">
                                ...
                                <ul class="dropdown-menu messages">
                                    ...
                                    <li>
                                        <a href="#">
                                            <span class="avatar"><img src="<?php echo base_url();?>admin_assets/img/avatar.jpg" alt="Avatar"></span>
                                            <span class="header">
                                                <span class="from">
                                                    Dennis Ji
                                                </span>
                ...
                <div id="sidebar-left" class="span2">
                    <div class="nav-collapse sidebar-nav">
                        <ul class="nav nav-tabs nav-stacked main-menu">
                            <li><a href="<?php echo base_url();?>Dashboard/index.html"><i class="icon-bar-chart"></i><span class="hidden-tablet"> Dashboard</span></a></li>	
                            <li><a href="<?php echo base_url();?>Dashboard/add_category"><i class="icon-envelope"></i><span class="hidden-tablet">Add Category</span></a></li>
                            <li><a href="<?php echo base_url();?>Dashboard/add_blog_category"><i class="icon-envelope"></i><span class="hidden-tablet">Add Blog Category</span></a></li>
                            <li><a href="<?php echo base_url();?>Dashboard/add_blog"><i class="icon-envelope"></i><span class="hidden-tablet">Add Blog</span></a></li>
                            <li><a href="<?php echo base_url();?>Dashboard/manage_category"><i class="icon-tasks"></i><span class="hidden-tablet">Manage Category</span></a></li>
                            <li><a href="<?php echo base_url();?>Dashboard/add_course"><i class="icon-eye-open"></i><span class="hidden-tablet">Add Course</span></a></li>
                            <li><a href="<?php echo base_url();?>Dashboard/manage_course"><i class="icon-dashboard"></i><span class="hidden-tablet">Manage Courses</span></a></li>
                            <li>
