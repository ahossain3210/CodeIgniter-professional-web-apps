...
<html lang="en">
    <head>
        ...
        <!--[if lt IE 9]>
                ...
                <link id="ie-style" href="<?php echo base_url();?>admin_assets/css/ie.css" rel="stylesheet">
        <![endif]-->

        <!--[if IE 9]>
                <link id="ie9style" href="<?php echo base_url();?>admin_assets/css/ie9.css" rel="stylesheet">
        <![endif]-->
                ...
                <div class="row-fluid">
                    <div class="login-box">
                        ...
                        <h2 style="color:green">
                            <?php
                            $log_message=$this->session->userdata('log_message');
                            if($log_message)
                            {
                                echo $log_message;
                                $this->session->unset_userdata('log_message');
                            }
                            ?>
                        </h2>
